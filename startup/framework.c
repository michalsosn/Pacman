 ...
 *
 ****************************************************************************/
static void exceptionHandlerUndef(void) {
 ...
 *
 ****************************************************************************/
static void exceptionHandlerSwi(void) {
    register unsigned int programCounter asm("lr");
    unsigned int value = programCounter - (unsigned int) 0x04;
 ...
 *
 ****************************************************************************/
static void exceptionHandlerDabort(void) {
    register unsigned int programCounter asm("lr");
 ...
 *
 ****************************************************************************/
static void exceptionHandlerFiq(void) {
    register unsigned int programCounter asm("lr");
    unsigned int value = programCounter - (unsigned int) 0x04;
 ...
 *
 ****************************************************************************/
static void exceptionHandlerIrq(void) {
    register unsigned int programCounter asm("lr");
    unsigned int value = programCounter - (unsigned int) 0x04;
